...
alex:
 - url: KSW-Alex.JPG
   ...
   alt: Myself and Master Alex Suh at the Championships dedicated to Master Alison.
parents:
 - url: KSW-Parents.jpg
...
{% include gallery id="board" caption="Me as a black belt breaking a board." %}
...
{% include gallery id="bbc" caption="Archery at my first ever Black Belt Club." %}
...
{% include gallery id="instructorscourse" caption="Myself and two classmates graduating from the Junior Leadership Programme in November 2012." %}
...
{% include gallery id="ksn" caption="Me promoting to Second Degree Black Belt in June 2015." %}
...
{% include gallery id="covid" caption="Kuk Sool Classes on Zoom." %}
...
{% include gallery id="psbn" caption="Me promoting to Third Degree Black Belt in August 2021." %}
...
{% include gallery id="alison" caption="Master Alison leading at the Lowestoft Kuk Sool Won 30th Anniversary Extravaganza." %}
...
{% include gallery id="alex" caption="Myself and Master Alex Suh at the Championships dedicated to Master Alison." %}
...
{% include gallery id="parents" caption="My parents supporting me at my promotion to PSBN." %}
...
{% include gallery id="instructors" layout="full" caption="My instructors (Master Martin, Master Jon, and Master David) with me in recent years." %}
